...
const ChangePassword = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Input  type = "password" placeholder="current password" className={"profile__tab__input"} {...register('currentPassword')} />
      <Input  type = "password" placeholder="new password" className={"profile__tab__input"} {...register('newPassword')} />
      <Input  type = "password" placeholder="re new password" className={"profile__tab__input"} {...register('rePassword')} />
      <div className="profile__tab__splitField">
        <Button onClick={() => reset()} className={"btn__outline"}>discard changes</Button>
